...
function flash_kernel_ramdisk()
{
	...
	info "**************************"
      ...
      sudo mount ${SDDEV}4 /mnt/android_sdcard
      sudo cp $ROOT_DIR/kernel/arch/arm/boot/uImage /mnt/android_sdcard/
      sudo cp $ROOT_DIR/kernel/arch/arm/boot/dts/exynos4412-odroidx2.dtb /mnt/android_sdcard/
      sudo cp $ROOT_DIR/uboot/boot.scr /mnt/android_sdcard/
      sudo cp $OUT_DIR/ramdisk-uboot.img /mnt/android_sdcard/
